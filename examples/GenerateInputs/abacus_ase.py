...
kpts = [4,4,4]
calc = Abacus(atoms=cs_atoms, ntype=1, ecutwfc=20, scf_nmax=50, kspacing=0.04, smearing_method='gaussian', smearing_sigma=0.01, basis_type='lcao', ks_solver='genelpa', 
